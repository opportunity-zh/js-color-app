...
/* 
  Add atleast two more color "tiles" to the page.
  Each tile should have a unique id and also change the background color of the body element when clicked.
  Also don't forget the css to add a color to the tiles.
*/
